        ...
        <table className="w-full text-sm text-right">
          <thead className="bg-[#155645]/5 text-[#155645] uppercase text-xs">
            <tr>
              ...
              <th className="p-4 bg-slate-200/50">Qtd Orçada</th>
              <th className="p-4 bg-slate-200/50">Salário Orçado</th>
              <th className="p-4">Qtd Real (CLT)</th>
              <th className="p-4 text-orange-700">Afastados</th>
              <th className="p-4 text-blue-700">Jovem Ap.</th>
              <th className="p-4">Salário Real</th>
              <th className="p-4 text-center">Dif. Qtd</th>
              <th className="p-4 text-center">Dif. Valor</th>
              <th className="p-4 text-center">Dif. % Valor</th>
            </tr>
          </thead>
          ...
          <tfoot className="bg-slate-100 font-bold border-t border-slate-300">
            <tr>
              ...
              <td className="p-4">{totals.budgetQty}</td>
              <td className="p-4">R$ {totals.budgetValue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</td>
              <td className="p-4">{totals.realQty}</td>
              <td className="p-4 text-orange-700">{totals.afastadosQty}</td>
              <td className="p-4 text-blue-700">{totals.apprenticesQty}</td>
